...
CONFIG_CCACHE=y
CONFIG_CCACHE_DIR="$(TOPDIR)/.ccache"
...
CONFIG_PACKAGE_kmod-phy-bcm7xxx=y
...
# CONFIG_PACKAGE_kmod-drm-panel-simple is not set
...
CONFIG_PACKAGE_kmod-rtl8192d-common=y
...
# CONFIG_PACKAGE_libvulkan-nouveau is not set
...
# CONFIG_PACKAGE_luci-i18n-frps-fa is not set
# CONFIG_PACKAGE_luci-i18n-frps-fi is not set
# CONFIG_PACKAGE_luci-i18n-frps-fr is not set
# CONFIG_PACKAGE_luci-i18n-frps-ga is not set
...
# CONFIG_PACKAGE_luci-i18n-frps-nl is not set
...
# CONFIG_PACKAGE_luci-i18n-frps-ta is not set
...
# CONFIG_PACKAGE_qt5graphicaleffects is not set
...
# CONFIG_PACKAGE_qt5script-examples is not set
